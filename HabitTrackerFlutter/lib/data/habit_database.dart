...
class FitnessDatabase {
  ...
  void loadData() {
    ...
    if (_myBox.get(todaysDateFormatted()) == null) {
      todaysworkoutList = _myBox.get("CURRENT_HABIT_LIST");
  ...
  void updateDatabase() {
    ...
    _myBox.put("CURRENT_HABIT_LIST", todaysworkoutList);
  ...
  void calculateHabitPercentages() {
    ...
    String percent = todaysworkoutList.isEmpty
        ? '0.0'
        : (countCompleted / todaysworkoutList.length).toStringAsFixed(1);
